...
const DENY_TIMEOUT_NOTE =
  "Junction: nobody answered this permission request in time. Skip this action and finish what you can without it.";
  ...
  async create(input: DriverCreateInput<CodexConfig>): Promise<ProviderInstance> {
    ...
    const sendTurn = async (turn: SendTurnInput) => {
      ...
      const settle = (ok: boolean, stopReason: string | null) => {
        ...
        state.settled = true;
        for (const finish of [...asks.values()]) finish("deny", "Junction: the turn ended");
